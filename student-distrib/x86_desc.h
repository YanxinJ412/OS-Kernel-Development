...
/* Number of page tables in the page directory */
#define NUM_PDE     1024
#define NUM_PTE     1024
#define page_size   1024

/* align your pages (page directory and page tables) on 4 kB boundaries */
#define KB_4        4096
...
/* An page directory entry(4KB page table) (goes into the PD) */
...
/* An page directory entry(4MB page table) (goes into the PD) */
typedef struct __attribute__ ((packed)) {
    uint32_t present   : 1;
    uint32_t R_W       : 1;
    uint32_t U_S       : 1;
...
extern page_directory_entry_t page_directory[NUM_PDE] __attribute__((aligned (KB_4)));
/* The page table itself (declared in x86_desc.S) */
extern page_table_entry_t page_table[NUM_PTE] __attribute__((aligned (KB_4)));
extern page_table_entry_t page_vm_table[NUM_PTE] __attribute__((aligned (KB_4)));
