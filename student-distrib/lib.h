...
// vertically scroll down
void vertical_scroll();
void vertical_scroll_keyboard();
// update the position of cursor
void update_cursor();
// update the position of cursor for current terminal
void update_cursor_key();
// store position for current terminal
void store_pos(int term_id);
// reset position in video memory
...
// for current terminal
void clear_key(void);
// initialize color for different terminals
void color_init();
